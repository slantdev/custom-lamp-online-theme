				...
				<div class = "row">
					<div class = "col-md-8 pl-md-0 pr-md-4">
						...
						<?php if(get_field('banner_image')): ?>
							<div class = "page-image"><img src = "<?php echo get_field('banner_image'); ?>" alt = "<?php echo get_field('banner_image_description'); ?>" /></div>
						<?php endif; ?>
						<div class = "page-content"><?php echo esc_attr(htmlentities(the_content()));	?></div>
					</div>
